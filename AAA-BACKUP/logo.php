...
// echo $_SERVER['SERVER_NAME']."/$page_name/";
// exit;
...
?>
				...
				<div class="table_center">
					<div class="drop-down">
						<div id="dropDown" class="drop-down__button">
							<span class="drop-down__name"><?php echo $_SESSION['imie'].' '.$_SESSION['nazwisko'];?></span>
						</div>
						...
						<?php if($_SESSION['uprawnienia'] === 1 ){?>
							<li data-name="dashboard" class="drop-down__item">
									<a href="<?php URL;?>admin/admin.php">Administracja</a>
								</li>
									 
								<li data-name="dashboard" class="drop-down__item">
									<a href="<?php URL;?>test/test.php" target="_blank">TEST</a>
								</li>
						<?php } ?>
										
						<li data-name="activity" class="drop-down__item Log-out">
	...
	<?php }else{?>
			<div id="dane"><div class="table_center">
					<div class="drop-down">
						<div id="dropDown" class="drop-down__button">
							<span class="drop-down__name"><a class="Log-in" href="<?php echo URL;?>logowanie/logowanie.php">Sign in</a></span>
						</div>
					</div>
			</div>
<?php }?>
